...
class GaussianDiffusion(nn.Module):
    ...
    def get_conv(self, dims, std, mode='circular'):
        ...
        with torch.no_grad():
            ...
            kernel = torch.unsqueeze(kernel, 0) # add batch and channel dimensions
    ...
    def get_kernels(self):
        ...
        for i in range(self.num_timesteps):
            if self.blur_routine == 'Incremental':
                ...
                kernels.append(self.get_conv((ks, ks), (kstd, kstd), mode='reflect')) # exponential kernel size
        ...
        return kernels # list of convolutions
    ...
    def train(self):
        ...
        while self.step < self.train_num_steps:
            ...
            if self.step != 0 and self.step % self.save_and_sample_every == 0:
                ...
                xt = (xt + 1) * 0.5 #make it 0-1 for saving
